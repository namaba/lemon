class UserProfile < ActiveRecord::Base
  ...
  enum job:         {'会社員': 1, '弁護士': 2, '公認会計士': 3, '経営者・役員': 4, '公務員': 5, '事務員': 6, '大手商社': 7, '外資金融': 8, '大手企業': 9, '大手外資': 10, 'クリエイター': 11, 'IT関連': 12, 'パイロット': 13, '芸能・モデル': 14, '医師': 15, 'アパレル・ショップ': 16, 'アナウンサー': 17, '保育士': 18, '自由業': 19, '学生': 20, '上場企業': 21, '金融': 22, 'コンサル': 23, '調理師・栄養士': 24, '教育関連': 25, '食品関連': 26, '製菓': 27, '保険': 28, '不動産': 29, '建築関連': 30, '通信': 31, '流通': 32, 'WEB業界': 33, '接客業': 34, 'エンターテインメント': 35, 'ブライダル': 36, '福祉・介護': 37, '広告': 38, 'マスコミ': 39, '他': 99}
